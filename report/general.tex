...
Unser Hauptaugenmerk bei der Testabdeckung lag beim Assembler.\todo{Wenn man mal den Assembler gegen die hardware vergleicht, dann gewinnt die hardware :D} Da der Assembler in Python geschrieben ist, nutzten wir  für das automatisierte Testen PyUnit, die für Python angepasste Version von JUnit.
